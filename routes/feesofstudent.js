...
router.get("/fees-menu",isLoggedIn,isAdmin,wrapAsync(async(req,res)=>{
    const fees_setting=[
        {
            class:"First",
            fees: 10
    ...
    MonthlyPlan.findOneAndUpdate({_id:newMonthlyPlan._id}, {"listed":true}, {upsert: true}, function(err, doc) {
